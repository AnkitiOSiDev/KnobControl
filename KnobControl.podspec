...
spec.homepage     = "http://raywenderlich.com"
  ...
  spec.author             = { "Ankit" => "ankitshrivastavano.2@gmail.com" }
  # Or just: spec.author    = "Ankit"
  # spec.authors            = { "Ankit" => "ankitshrivastavano.2@gmail.com" }
 ...
 # spec.platform     = :ios
  ...
  spec.source       = { :git => "https://github.com/AnkitiOSiDev/KnobControl.git", :tag => "1.0.0" }
